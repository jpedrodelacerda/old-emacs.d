...
*** I really like the gruvbox-dark theme, so that's what I'm rolling with.
...
#+BEGIN_SRC emacs-lisp
  (use-package ycmd
	:init
	(setq ycmd-server-command '("python" "/home/joao/YouCompleteMe/third_party/ycmd/ycmd"))
    (set-variable 'ycmd-global-config "/home/jpedrodelacerda/YouCompleteMe/.ycm_extra_conf.py")
...
#+BEGIN_SRC emacs-lisp
  (setenv "GOPATH" "/home/jpedrodelacerda/go")
